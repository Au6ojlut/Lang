...
f = open("fourgrams.txt", 'r', encoding="utf8")    # open file with smth need to train
for line in f:
...
w = open('vec_fourgrams_tr.txt', 'w', encoding="utf8")
for line in f:
...
w = open('vec_fourgrams_ts.txt', 'w', encoding="utf8")
for line in f:
